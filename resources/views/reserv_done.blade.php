...
@section('main')
    <h2 class="my-3 text-center">Your reservation sent to Publisher. You will be contacted soon.</h2>
    <h2 class="my-3 text-center">Reservation information</h2>
    <h3 class="my-3 text-center">Reservation City: {{$offer->offer_city}}</h3>
    <h3 class="my-3 text-center">Reservation Hotel: {{$offer->offer_hotel}}</h3>
